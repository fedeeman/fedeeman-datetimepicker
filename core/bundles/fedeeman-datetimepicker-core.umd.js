(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    })(exports.MatDatetimepickerFilterType || (exports.MatDatetimepickerFilterType = {}));
    ...
    var MatDatetimepickerCalendar = /** @class */ (function () {
        function MatDatetimepickerCalendar(_elementRef, _intl, _ngZone, _adapter, _dateFormats, changeDetectorRef) {
            ...
            this._dateFilterForViews = function (date) {
                return !!date &&
                    (!_this.dateFilter || _this.dateFilter(date, exports.MatDatetimepickerFilterType.DATE)) &&
        ...
        MatDatetimepickerCalendar = __decorate([
            ...
            __param(4, core.Optional()), __param(4, core.Inject(MAT_DATETIME_FORMATS)),
            __metadata("design:paramtypes", [core.ElementRef,
                datepicker.MatDatepickerIntl,
                core.NgZone,
                DatetimeAdapter, Object, core.ChangeDetectorRef])
        ...
        MatDatetimepickerClock.prototype._init = function () {
            ...
            if (this.twelvehour) {
                ...
                for (var i = 0; i < hourNames.length; i++) {
                    ...
                    var enabled = (!this.minDate || this._adapter.compareDatetime(date, this.minDate) >= 0) &&
                        (!this.maxDate || this._adapter.compareDatetime(date, this.maxDate) <= 0) &&
                        (!this.dateFilter || this.dateFilter(date, exports.MatDatetimepickerFilterType.HOUR));
                    this._hours.push({
                        value: i,
                        displayValue: i === 0 ? "00" : hourNames[i],
                        enabled: enabled,
            ...
            for (var i = 0; i < minuteNames.length; i += 5) {
                ...
                var enabled = (!this.minDate || this._adapter.compareDatetime(date, this.minDate) >= 0) &&
                    (!this.maxDate || this._adapter.compareDatetime(date, this.maxDate) <= 0) &&
                    (!this.dateFilter || this.dateFilter(date, exports.MatDatetimepickerFilterType.MINUTE));
                this._minutes.push({
                    value: i,
    ...
    var MatDatetimepickerContent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild(MatDatetimepickerCalendar, { static: true }),
    ...
    var MatDatetimepicker = /** @class */ (function () {
        ...
        MatDatetimepicker = __decorate([
            ...
            __metadata("design:paramtypes", [dialog.MatDialog,
                overlay.Overlay,
                core.NgZone,
                core.ViewContainerRef, Object, DatetimeAdapter,
    ...
    var MatDatetimepickerInput = /** @class */ (function () {
        function MatDatetimepickerInput(_elementRef, _dateAdapter, _dateFormats, _formField) {
            ...
            this._filterValidator = function (control) {
                var controlValue = _this._dateAdapter.getValidDateOrNull(_this._dateAdapter.deserialize(control.value));
                return !_this._dateFilter || !controlValue || _this._dateFilter(controlValue, exports.MatDatetimepickerFilterType.DATE) ?
        ...
        MatDatetimepickerInput = MatDatetimepickerInput_1 = __decorate([
            core.Directive({
                ...
                providers: [
                    ...
                    { provide: input.MAT_INPUT_VALUE_ACCESSOR, useExisting: MatDatetimepickerInput_1 },
                ],
                host: {
            ...
            __param(2, core.Optional()), __param(2, core.Inject(MAT_DATETIME_FORMATS)),
            __param(3, core.Optional()),
            __metadata("design:paramtypes", [core.ElementRef,
                DatetimeAdapter, Object, formField.MatFormField])
    ...
    var MatDatetimepickerToggle = /** @class */ (function () {
        ...
        MatDatetimepickerToggle = __decorate([
            ...
            __metadata("design:paramtypes", [datepicker.MatDatepickerIntl, core.ChangeDetectorRef])
    ...
    var MatDatetimepickerMonthView = /** @class */ (function () {
        ...
        MatDatetimepickerMonthView = __decorate([
            ...
            __param(1, core.Optional()), __param(1, core.Inject(MAT_DATETIME_FORMATS)),
...
//# sourceMappingURL=fedeeman-datetimepicker-core.umd.js.map
